...
const MessageContent = ({ isTemp, type, content, entity, popupsData }) => {
  ...
  if (!MessageContent && isDispute) {
    messageContent = disputeMessageContent({ type, content, entity });
  }
