...
const VerticalListingsWithMapFullWidth = () => {
  return (
    <>
                            ...
                            <div className="col-lg-8 col-md-8 p-0">
                              <div className="listings-content">
                                ...
                                <ul className="listings-meta">
                                  ...
                                  <li>
                                    <a href="#">
                                      <i className="flaticon-pin"></i> New York,
                                      USA
                                    </a>
                                  </li>
                                </ul>
                            ...
                            <div className="col-lg-8 col-md-8 p-0">
                              <div className="listings-content">
                                ...
                                <ul className="listings-meta">
                                  ...
                                  <li>
                                    <a href="#">
                                      <i className="flaticon-pin"></i> Los
                                      Angeles, USA
                                    </a>
                                  </li>
                                </ul>
                            ...
                            <div className="col-lg-8 col-md-8 p-0">
                              <div className="listings-content">
                                ...
                                <ul className="listings-meta">
                                  ...
                                  <li>
                                    <a href="#">
                                      <i className="flaticon-pin"></i> Seattle,
                                      USA
                                    </a>
                                  </li>
                                </ul>
...
export default VerticalListingsWithMapFullWidth;
