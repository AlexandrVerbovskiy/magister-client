    ...
    <div className="relative inline-flex">
      ...
      >
        <div className="flex items-center truncate">
          <span className="truncate font-medium text-teal-500 group-hover:text-teal-600 dark:group-hover:text-teal-400">My Personal Account</span>
          <svg className="w-3 h-3 shrink-0 ml-1 fill-current text-teal-400" viewBox="0 0 12 12">
