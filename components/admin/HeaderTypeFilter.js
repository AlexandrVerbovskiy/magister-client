const activeButtonClasses =
  "inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-transparent shadow-sm bg-teal-500 text-white duration-150 ease-in-out";
...
const activeSpanClasses = "ml-1 text-teal-200";
