...
import { baseTimeListPageParams, fullTimeConverter, timeConverter } from "../../utils";
...
const ths = [
  ...
  { title: "Type", value: "recipient_payments.type", width: "15%" },
  { title: "Status", value: "recipient_payments.status", width: "15%" },
  { title: "Get at", value: "recipient_payments.planned_time", width: "10%" },
];
...
const Tr = ({
  ...
  return (
    <tr>
      ...
      <td style={{ fontWeight: "700" }}>{timeConverter(plannedTime)}</td>
    </tr>
  );
};
