...
import Image from '../../public/admin_images/transactions-image-04.svg';
          ...
          <div className="max-w-sm mx-auto lg:max-w-none">
            ...
            <div className="drop-shadow-lg mt-12">
              ...
              <div className="bg-white dark:bg-slate-700 rounded-t-xl px-5 pb-2.5 text-center">
                ...
                <div className="text-sm font-medium text-slate-800 dark:text-slate-100 mb-3">Acme LTD UK</div>
                <div className="text-xs inline-flex font-medium bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 rounded-full text-center px-2.5 py-1">Pending</div>
              </div>
              {/* Divider */}
