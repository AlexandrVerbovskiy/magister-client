    ...
    <div className="grow">
     ...
     {/* Panel body */}
      <div className="p-6 space-y-6">
          ...
          <div>
           ...
           {/* Pricing tabs */}
            <div className="grid grid-cols-12 gap-6">
             ...
             {/* Tab 2 */}
              <div className="relative col-span-full xl:col-span-4 bg-white dark:bg-slate-800 shadow-md rounded-sm border border-slate-200 dark:border-slate-700">
                ...
                <div className="px-5 pt-5 pb-6 border-b border-slate-200 dark:border-slate-700">
                 ...
                 {/* CTA */}
                  <button className="btn w-full bg-teal-500 hover:bg-teal-600 text-white disabled:border-slate-200 dark:disabled:border-slate-700 disabled:bg-slate-100 dark:disabled:bg-slate-800 disabled:text-slate-400 dark:disabled:text-slate-600 disabled:cursor-not-allowed shadow-none" disabled>
             ...
             {/* Tab 3 */}
              <div className="relative col-span-full xl:col-span-4 bg-white dark:bg-slate-800 shadow-md rounded-sm border border-slate-200 dark:border-slate-700">
                <div className="absolute top-0 left-0 right-0 h-0.5 bg-teal-500" aria-hidden="true"></div>
                <div className="px-5 pt-5 pb-6 border-b border-slate-200 dark:border-slate-700">
                  <header className="flex items-center mb-2">
                    <div className="w-6 h-6 rounded-full shrink-0 bg-gradient-to-tr from-teal-500 to-teal-300 mr-3">
                      <svg className="w-6 h-6 fill-current text-white" viewBox="0 0 24 24">
                        <path d="M12 17a.833.833 0 01-.833-.833 3.333 3.333 0 00-3.334-3.334.833.833 0 110-1.666 3.333 3.333 0 003.334-3.334.833.833 0 111.666 0 3.333 3.333 0 003.334 3.334.833.833 0 110 1.666 3.333 3.333 0 00-3.334 3.334c0 .46-.373.833-.833.833z" />
                      </svg>
                    </div>
                 ...
                 {/* CTA */}
                  <button className="btn bg-teal-500 hover:bg-teal-600 text-white w-full">Upgrade</button>
                </div>
                <div className="px-5 pt-4 pb-5">
                  <div className="text-xs text-slate-800 dark:text-slate-100 font-semibold uppercase mb-4">What's included</div>
                 {/* List */}
       ...
       {/* Contact Sales */}
        <section>
          <div className="px-5 py-3 bg-teal-50 dark:bg-teal-500/30 border border-teal-100 dark:border-transparent rounded-sm text-center xl:text-left xl:flex xl:flex-wrap xl:justify-between xl:items-center">
            <div className="text-slate-800 dark:text-slate-100 font-semibold mb-2 xl:mb-0">Looking for different configurations?</div>
            <button className="btn bg-teal-500 hover:bg-teal-600 text-white">Contact Sales</button>
          </div>
        </section>
        ...
        <section>
          ...
          <ul className="space-y-5">
            ...
            <li>
              ...
              <div className="text-sm">
                Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum in voluptate velit esse cillum dolore eu fugiat <a className="font-medium text-teal-500 hover:text-teal-600 dark:hover:text-teal-400" href="#0">contact us</a>.
              </div>
            </li>
          </ul>
        </section>
      ...
      <footer>
        <div className="flex flex-col px-6 py-5 border-t border-slate-200 dark:border-slate-700">
          <div className="flex self-end">
            ...
            <button className="btn bg-teal-500 hover:bg-teal-600 text-white ml-3">Save Changes</button>
          </div>
        </div>
      </footer>
