...
import UserImage from '../../public/admin_images/user-64-14.jpg';
import FintechIcon01 from '../../public/admin_images/company-icon-01.svg';
import FintechIcon02 from '../../public/admin_images/company-icon-02.svg';
import FintechIcon03 from '../../public/admin_images/company-icon-03.svg';
import FintechIcon04 from '../../public/admin_images/company-icon-04.svg';
      ...
      <div className="px-5 py-6">
        <div className="md:flex md:justify-between md:items-center">
          ...
          <ul className="shrink-0 flex flex-wrap justify-end md:justify-start -space-x-3 -ml-px">
            ...
            <li>
              <button className="flex justify-center items-center w-9 h-9 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-teal-500 shadow-sm transition duration-150">
