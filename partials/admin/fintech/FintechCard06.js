...
import UserImage from '../../public/admin_images/user-36-05.jpg';
    ...
    <div className="col-span-full xl:col-span-6 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
      ...
      <div className="p-3">
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="flex items-center">
                    <div className="shrink-0 rounded-full mr-2 sm:mr-3 bg-teal-500">
                      <svg className="w-9 h-9 fill-current text-teal-50" viewBox="0 0 36 36">
        ...
        <div className="text-center border-t border-slate-100 dark:border-slate-700 px-2">
          <a className="block text-sm font-medium text-teal-500 hover:text-teal-600 dark:hover:text-teal-400 pt-4 pb-1" href="#0">
            View All -&gt;
          </a>
        </div>
      </div>
