      ...
      <div className="flex flex-col h-full">
          ...
          <div className="flex justify-between items-start">
            ...
            <header>
              <div className="flex mb-2">
                <Link className="relative inline-flex items-start mr-5" href={props.link}>
                ...
                <div className="mt-1 pr-1">
                  <Link className="inline-flex text-slate-800 dark:text-slate-100 hover:text-slate-900 dark:hover:text-white" href={props.link}>
            ...
            <EditMenu align="right" className="relative inline-flex shrink-0">
              <li>
                <Link className="font-medium text-sm text-slate-600 dark:text-slate-300 hover:text-slate-800 dark:hover:text-slate-200 flex py-1 px-3" href="#0">Option 1</Link>
              </li>
              <li>
                <Link className="font-medium text-sm text-slate-600 dark:text-slate-300 hover:text-slate-800 dark:hover:text-slate-200 flex py-1 px-3" href="#0">Option 2</Link>
              </li>
              <li>
        ...
        <div className="border-t border-slate-200 dark:border-slate-700">
          <div className="flex divide-x divide-slate-200 dark:divide-slate-700">
            <Link className="block flex-1 text-center text-sm text-teal-500 hover:text-teal-600 dark:hover:text-teal-400 font-medium px-3 py-4" href="/messages">
            ...
            <Link className="block flex-1 text-center text-sm text-slate-600 hover:text-slate-800 dark:text-slate-300 dark:hover:text-slate-200 font-medium px-3 py-4 group" href="/dashboard/account">
              <div className="flex items-center justify-center">
