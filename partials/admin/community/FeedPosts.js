...
import EditMenu from '../../components/admin/DropdownEditMenu';

import UserImage02 from '../../public/admin_images/user-40-02.jpg';
import UserImage03 from '../../public/admin_images/user-40-03.jpg';
import UserImage04 from '../../public/admin_images/user-40-04.jpg';
import UserImage06 from '../../public/admin_images/user-40-06.jpg';
import UserImage08 from '../../public/admin_images/user-40-08.jpg';
import CommenterImage04 from '../../public/admin_images/user-32-04.jpg';
import CommenterImage05 from '../../public/admin_images/user-32-05.jpg';
import FeedImage01 from '../../public/admin_images/feed-image-01.jpg';
import FeedImage02 from '../../public/admin_images/feed-image-02.jpg';
  ...
  return (
    <>
      ...
      <div className="bg-white dark:bg-slate-800 shadow-md rounded border border-slate-200 dark:border-slate-700 p-5">
        ...
        <header className="flex justify-between items-start space-x-3 mb-3">
          ...
          <EditMenu align="right" className="relative inline-flex shrink-0">
            <li>
              <Link className="font-medium text-sm text-slate-600 dark:text-slate-300 hover:text-slate-800 dark:hover:text-slate-200 flex py-1 px-3" href="#0">
                Option 1
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link className="font-medium text-sm text-rose-500 hover:text-rose-600 flex py-1 px-3" href="#0">
                Remove
              </Link>
            </li>
          </EditMenu>
        ...
        <footer className="flex items-center space-x-4">
          {/* Like button */}
          <button className="flex items-center text-slate-400 dark:text-slate-500 hover:text-teal-500 dark:hover:text-teal-500">
          ...
          <div className="relative !my-4">
            ...
            <div className="absolute left-0 right-0 bottom-0 p-4 bg-black bg-opacity-25 backdrop-blur-md">
              <div className="flex items-center justify-between">
                ...
                <a className="text-xs font-medium text-teal-400 hover:text-teal-300" href="#0">
                  Learn More -&gt;
                </a>
              </div>
            </div>
      ...
      <div className="bg-white dark:bg-slate-800 shadow-md rounded border border-slate-200 dark:border-slate-700 p-5">
        ...
        <div className="mt-5 pt-3 border-t border-slate-200 dark:border-slate-700">
          ...
          <div className="flex justify-between space-x-2">
            ...
            <button className="text-sm  font-medium text-teal-500 hover:text-teal-600 dark:hover:text-teal-400">View More Comments</button>
          </div>
          {/* Comment form */}
      ...
      <div className="bg-white dark:bg-slate-800 shadow-md rounded border border-slate-200 dark:border-slate-700 p-5">
        ...
        <footer className="flex items-center space-x-4">
          {/* Like button */}
          <button className="flex items-center text-teal-400 dark:text-teal-500">
            <svg className="w-4 h-4 shrink-0 fill-current mr-1.5" viewBox="0 0 16 16">
              <path d="M14.682 2.318A4.485 4.485 0 0011.5 1 4.377 4.377 0 008 2.707 4.383 4.383 0 004.5 1a4.5 4.5 0 00-3.182 7.682L8 15l6.682-6.318a4.5 4.5 0 000-6.364zm-1.4 4.933L8 12.247l-5.285-5A2.5 2.5 0 014.5 3c1.437 0 2.312.681 3.5 2.625C9.187 3.681 10.062 3 11.5 3a2.5 2.5 0 011.785 4.251h-.003z" />
            </svg>
            <div className="text-sm text-teal-500">2.2K</div>
          </button>
          {/* Share button */}
          <button className="flex items-center text-slate-400 dark:text-slate-500 hover:text-teal-500 dark:hover:text-teal-500">
            <svg className="w-4 h-4 shrink-0 fill-current mr-1.5" viewBox="0 0 16 16">
