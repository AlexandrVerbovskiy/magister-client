...
import ProfileBg from '../../public/admin_images/profile-bg.jpg';
import UserAvatar from '../../public/admin_images/user-128-01.jpg';
import Icon02 from '../../public/admin_images/icon-02.svg';
import Icon03 from '../../public/admin_images/icon-03.svg';
import UserImage01 from '../../public/admin_images/avatar-01.jpg';
import UserImage02 from '../../public/admin_images/avatar-02.jpg';
import UserImage03 from '../../public/admin_images/avatar-03.jpg';
import UserImage04 from '../../public/admin_images/avatar-04.jpg';
import UserImage05 from '../../public/admin_images/avatar-05.jpg';
import UserImage06 from '../../public/admin_images/avatar-06.jpg';
        ...
        <div className="-mt-16 mb-6 sm:mb-3">
          <div className="flex flex-col items-center sm:flex-row sm:justify-between sm:items-end">
            ...
            <div className="inline-flex -ml-1 -mt-1 mb-4 sm:mb-0">
              <img className="rounded-full border-4 border-white dark:border-slate-900" src={UserAvatar} width="128" height="128" alt="Avatar" />
            </div>
            ...
            <div className="flex space-x-2 sm:mb-2">
              ...
              <button className="p-1.5 shrink-0 rounded bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 shadow-sm">
                <svg className="w-4 h-4 fill-current text-teal-500" viewBox="0 0 16 16">
                  <path d="M8 0C3.6 0 0 3.1 0 7s3.6 7 8 7h.6l5.4 2v-4.4c1.2-1.2 2-2.8 2-4.6 0-3.9-3.6-7-8-7Zm4 10.8v2.3L8.9 12H8c-3.3 0-6-2.2-6-5s2.7-5 6-5 6 2.2 6 5c0 2.2-2 3.8-2 3.8Z" />
                </svg>
              </button>
              <button className="btn bg-teal-500 hover:bg-teal-600 text-white">
        ...
        <header className="text-center sm:text-left mb-6">
          ...
          <div className="flex flex-wrap justify-center sm:justify-start space-x-4">
            ...
            <div className="flex items-center">
              ...
              <a className="text-sm font-medium whitespace-nowrap text-teal-500 hover:text-teal-600 dark:hover:text-teal-400 ml-2" href="#0">
                carolinmcneail.com
              </a>
            </div>
          </div>
              ...
              <div className="grid xl:grid-cols-2 gap-4">
                ...
                <div className="bg-white dark:bg-slate-800 p-4 border border-slate-200 dark:border-slate-700 rounded-sm shadow-sm">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex -space-x-3 -ml-0.5">
                      <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={UserImage02} width="24" height="24" alt="Avatar" />
                      <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={UserImage03} width="24" height="24" alt="Avatar" />
                      <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={UserImage04} width="24" height="24" alt="Avatar" />
                      <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={UserImage05} width="24" height="24" alt="Avatar" />
                    </div>
                    {/* Link */}
                    <div>
                      <a className="text-sm font-medium text-teal-500 hover:text-teal-600 dark:hover:text-teal-400" href="#0">
                        View -&gt;
                      </a>
                    </div>
                  </div>
                ...
                <div className="bg-white dark:bg-slate-800 p-4 border border-slate-200 dark:border-slate-700 rounded-sm shadow-sm">
                  ...
                  <div className="flex justify-between items-center">
                    {/* Avatars group */}
                    <div className="flex -space-x-3 -ml-0.5">
                      <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={UserImage06} width="24" height="24" alt="Avatar" />
                      <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={UserImage03} width="24" height="24" alt="Avatar" />
                      <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={UserImage01} width="24" height="24" alt="Avatar" />
                    </div>
                    {/* Link */}
                    <div>
                      <a className="text-sm font-medium text-teal-500 hover:text-teal-600 dark:hover:text-teal-400" href="#0">
              ...
              <div className="bg-white dark:bg-slate-800 p-4 border border-slate-200 dark:border-slate-700 rounded-sm shadow-sm">
                <ul className="space-y-3">
                  ...
                  <li className="sm:flex sm:items-center sm:justify-between">
                    <div className="sm:grow flex items-center text-sm">
                      {/* Icon */}
                      <div className="w-8 h-8 rounded-full shrink-0 bg-teal-500 my-2 mr-3">
                        <svg className="w-8 h-8 fill-current text-teal-50" viewBox="0 0 32 32">
