...
import ProfileImage from '../../public/admin_images/user-avatar-32.png';
...
import UserImage08 from '../../public/admin_images/user-32-08.jpg';
        ...
        <div>
          ...
          <div className="px-5 py-4">
            ...
            <div className="mt-4">
              ...
              <ul className="mb-6">
                <li className="-mx-2">
                  <button className="w-full p-2 rounded bg-indigo-500/30" onClick={() => setProfileSidebarOpen(false)}>
