...
import MeetupsThumb01 from '../../public/admin_images/meetups-thumb-01.jpg';
import MeetupsThumb02 from '../../public/admin_images/meetups-thumb-02.jpg';
import MeetupsThumb03 from '../../public/admin_images/meetups-thumb-03.jpg';
import MeetupsThumb04 from '../../public/admin_images/meetups-thumb-04.jpg';
import MeetupsThumb05 from '../../public/admin_images/meetups-thumb-05.jpg';
import MeetupsThumb06 from '../../public/admin_images/meetups-thumb-06.jpg';
import MeetupsThumb07 from '../../public/admin_images/meetups-thumb-07.jpg';
import MeetupsThumb08 from '../../public/admin_images/meetups-thumb-08.jpg';
  ...
  return (
    <div className="grid xl:grid-cols-2 gap-6">
      ...
      <article className="flex bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
        {/* Image */}
        <Link className="relative block w-24 sm:w-56 xl:sidebar-expanded:w-40 2xl:sidebar-expanded:w-56 shrink-0" href="/community/meetups-post">
          <img
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold text-teal-500 uppercase mb-2">Mon 27 Dec, 2021</div>
      ...
      <article className="flex bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold text-teal-500 uppercase mb-2">Wed 29 Dec, 2021</div>
            <Link className="inline-flex mb-2" href="/community/meetups-post">
      ...
      <article className="flex bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold text-teal-500 uppercase mb-2">Mon 3 Jan, 2022</div>
            <Link className="inline-flex mb-2" href="/community/meetups-post">
      ...
      <article className="flex bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold text-teal-500 uppercase mb-2">Thu 6 Jan, 2022</div>
            <Link className="inline-flex mb-2" href="/community/meetups-post">
      ...
      <article className="flex bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold text-teal-500 uppercase mb-2">Fri 7 Jan, 2022</div>
            <Link className="inline-flex mb-2" href="/community/meetups-post">
