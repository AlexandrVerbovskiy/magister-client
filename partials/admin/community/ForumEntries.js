...
import UserAvatar from '../../public/admin_images/user-avatar-32.png';
import UserImage01 from '../../public/admin_images/user-32-01.jpg';
import UserImage02 from '../../public/admin_images/user-32-02.jpg';
import UserImage03 from '../../public/admin_images/user-32-03.jpg';
import UserImage04 from '../../public/admin_images/user-32-04.jpg';
import UserImage05 from '../../public/admin_images/user-32-05.jpg';
import UserImage06 from '../../public/admin_images/user-32-06.jpg';
import UserImage07 from '../../public/admin_images/user-32-07.jpg';
      ...
      <article className="bg-white dark:bg-slate-800 shadow-md rounded border border-slate-200 dark:border-slate-700 p-5">
        <div className="flex flex-start space-x-4">
          ...
          <div className="shrink-0">
            <button className="text-xs font-semibold text-center h-12 w-12 border border-teal-400 rounded-sm flex flex-col justify-center items-center outline outline-2 outline-teal-100 dark:outline-teal-500/10">
              <svg className="inline-flex fill-teal-500 mt-1.5 mb-1.5" width="12" height="6" xmlns="http://www.w3.org/2000/svg">
