...
import UserAvatar from "../../public/admin_images/user-40-02.jpg";
import UserImage01 from "../../public/admin_images/user-28-01.jpg";
import UserImage02 from "../../public/admin_images/user-28-02.jpg";
import UserImage05 from "../../public/admin_images/user-28-05.jpg";
import UserImage09 from "../../public/admin_images/user-28-09.jpg";
import UserImage10 from "../../public/admin_images/user-28-10.jpg";
      ...
      <div className="mb-2">
        <ul className="inline-flex flex-wrap text-sm font-medium">
          <li className="flex items-center">
            ...
            <svg
              className="h-4 w-4 fill-current text-slate-400 dark:text-slate-500 mx-2"
              viewBox="0 0 16 16"
            >
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <div className="flex flex-wrap text-xs">
                  ...
                  <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 dark:after:text-slate-600 after:px-2">
                    <a
                      className="font-medium text-slate-500 hover:text-slate-600 dark:hover:text-slate-400"
                      href="#0"
                    >
                      Reply
                    </a>
