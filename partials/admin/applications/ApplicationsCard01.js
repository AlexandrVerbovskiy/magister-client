        ...
        <div className="grow flex flex-col p-5">
          ...
          <div className="grow">
            ...
            <div className="flex items-center space-x-2 mb-4">
              ...
              {/* Rate */}
              <div className="inline-flex text-sm font-medium bg-amber-100 dark:bg-amber-400/30 text-amber-600 dark:text-amber-400 rounded-full text-center px-2.5 py-0.5">
                {props.rating}
              </div>
            </div>
            {/* Features list */}
