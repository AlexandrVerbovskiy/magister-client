        ...
        return (
          <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
            <path
              ...
              d="M23.864 4.45L19.553.139l-2.337 4.663 1.98 1.98zM4.802 6.784l1.979-1.979L4.45.136.139 4.447z"
            />
            <path
              className="text-emerald-200"
              d="M4 15.385V8.619L0 6.614v10.769z"
            />
            <path
              className="text-emerald-500"
              d="M8.414 6L6 8.414v7.172L8.414 18h7.172L18 15.586V8.414L15.586 6z"
            />
            <path
              className="text-emerald-200"
              d="M8.615 4h6.766l2.005-4H6.617z"
            />
            <path
              className="text-emerald-400"
              d="M6.784 19.198l-1.98-1.98L.136 19.55l4.311 4.311z"
            />
            <path
              className="text-emerald-200"
              d="M20 8.615v6.766l4 2.005V6.617z"
            />
            <path
              className="text-emerald-400"
              d="M19.198 17.216l-1.979 1.979 2.331 4.669 4.311-4.311z"
            />
            <path
              className="text-emerald-200"
              d="M15.385 20H8.619l-2.005 4h10.769z"
            />
          </svg>
        );
      case 3:
