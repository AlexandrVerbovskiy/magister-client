...
import User01 from '../../public/admin_images/user-32-01.jpg';
import User02 from '../../public/admin_images/user-32-07.jpg';
        ...
        <div className="flex items-center">
          ...
          <div className="flex -space-x-3 -ml-px">
            <a className="block" href="#0">
              <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={User01} width="32" height="32" alt="User 01" />
            </a>
            <a className="block" href="#0">
              <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={User02} width="32" height="32" alt="User 04" />
            </a>
          </div>
        </div>
