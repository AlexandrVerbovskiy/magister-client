...
import UserImage01 from '../../public/admin_images/user-28-08.jpg';
...
function Task07() {
  return (
    <div className="bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 p-4">
      ...
      <div className="mb-3">
        {/* Title */}
        <h2 className="font-semibold text-slate-800 dark:text-slate-100 mb-1">Manage internal feedback</h2>
      </div>
      {/* Meta */}
      <div className="flex items-center justify-between">
        ...
        <div className="flex shrink-0 -space-x-3 -ml-px">
          <a className="block" href="#0">
            <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={UserImage01} width="28" height="28" alt="User 08" />
          </a>
        </div>
        {/* Right side */}
      ...
      <ul className="mt-3">
        <li className="flex items-center border-t border-slate-200 dark:border-slate-700 py-2">
          ...
          <div className="text-sm text-slate-400 dark:text-slate-500 line-through">Call with incoming clients</div>
        </li>
        <li className="flex items-center border-t border-slate-200 dark:border-slate-700 py-2">
          <svg className="w-3 h-3 shrink-0 fill-current text-emerald-500 mr-2" viewBox="0 0 12 12">
            <path d="M10.28 1.28L3.989 7.575 1.695 5.28A1 1 0 00.28 6.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 1.28z" />
          </svg>
          <div className="text-sm text-slate-400 dark:text-slate-500 line-through">Manage inbound deals</div>
        </li>
      </ul>
    </div>
  );
