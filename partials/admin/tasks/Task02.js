...
function Task02() {
  return (
    <div className="bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 p-4">
      ...
      <div className="mb-3">
        {/* Title */}
        <h2 className="font-semibold text-slate-800 dark:text-slate-100 mb-1">User should receive a daily digest email</h2>
        {/* Content */}
        <div>
      ...
      <div className="flex items-center justify-between">
        {/* Left side */}
        <button className="p-2 shrink-0 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-teal-500 transition duration-150">
