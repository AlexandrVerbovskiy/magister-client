...
import UserImage01 from '../../public/admin_images/user-28-12.jpg';
  ...
  return (
    <div className="bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 p-4">
      ...
      <div className="mb-3">
        ...
        <div className="flex items-center mb-2">
          <div className="flex shrink-0 -space-x-3 -ml-px mr-2">
            <a className="block" href="#0">
              <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={UserImage01} width="28" height="28" alt="User 12" />
            </a>
          </div>
          <div className="grow">
        ...
        {/* Content */}
        <div>
          <div className="text-sm">Dedicated form for a category of users that will perform actions? <a className="font-medium text-teal-500 hover:text-teal-600 dark:hover:text-teal-400" href="#0">#viewall</a></div>
        </div>
      </div>
      {/* Footer */}
