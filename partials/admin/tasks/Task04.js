...
import UserImage01 from '../../public/admin_images/user-28-06.jpg';
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex shrink-0 -space-x-3 -ml-px">
          <a className="block" href="#0">
            <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={UserImage01} width="28" height="28" alt="User 06" />
          </a>
        </div>
        {/* Right side */}
