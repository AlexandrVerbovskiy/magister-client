...
import TaskImage from '../../public/admin_images/task-image-02.jpg';
  ...
  return (
    <div className="bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 p-4">
      ...
      <div className="mb-3">
        ...
        {/* Content */}
        <div>
          <div className="text-sm">Publishing industries for previewing layouts and visual <a className="font-medium text-teal-500 hover:text-teal-600 dark:hover:text-teal-400" href="#0">#family</a> 🔥</div>
