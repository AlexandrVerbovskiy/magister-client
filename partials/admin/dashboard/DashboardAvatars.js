...
import User01 from '../../../public/admin_images/user-36-01.jpg';
import User02 from '../../../public/admin_images/user-36-02.jpg';
import User03 from '../../../public/admin_images/user-36-03.jpg';
import User04 from '../../../public/admin_images/user-36-04.jpg';
...
function DashboardAvatars() {
  return (
    <ul className="flex flex-wrap justify-center sm:justify-start mb-8 sm:mb-0 -space-x-3 -ml-px">
      ...
      <li>
        <button className="flex justify-center items-center w-9 h-9 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-teal-500 shadow-sm transition duration-150 ml-2">
