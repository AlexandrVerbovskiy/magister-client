...
import AppImage13 from '../../public/admin_images/applications-image-13.jpg';
import AppImage14 from '../../public/admin_images/applications-image-14.jpg';
import AppImage15 from '../../public/admin_images/applications-image-15.jpg';
import AppImage16 from '../../public/admin_images/applications-image-16.jpg';
      ...
      <div className="col-span-full sm:col-span-6 xl:col-span-3 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
        <div className="flex flex-col h-full">
          ...
          <div className="grow flex flex-col p-5">
            ...
            {/* Card footer */}
            <div>
              <a className="btn-sm w-full bg-teal-500 hover:bg-teal-600 text-white" href="#0">Back It</a>
            </div>
          </div>
        </div>
      </div>
