...
import AppImage01 from '../../public/admin_images/applications-image-01.jpg';
import AppImage02 from '../../public/admin_images/applications-image-02.jpg';
import AppImage03 from '../../public/admin_images/applications-image-03.jpg';
import AppImage04 from '../../public/admin_images/applications-image-04.jpg';
      ...
      <div className="col-span-full sm:col-span-6 xl:col-span-3 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
        <div className="flex flex-col h-full">
          ...
          <div className="grow flex flex-col p-5">
            ...
            {/* Card footer */}
            <div>
              <a className="btn-sm w-full bg-teal-500 hover:bg-teal-600 text-white" href="#0">Buy Now</a>
            </div>
          </div>
        </div>
      </div>
