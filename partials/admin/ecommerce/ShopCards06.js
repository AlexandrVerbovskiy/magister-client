...
import AppImage17 from '../../public/admin_images/applications-image-17.jpg';
import AppImage18 from '../../public/admin_images/applications-image-18.jpg';
import AppImage19 from '../../public/admin_images/applications-image-19.jpg';
import AppImage20 from '../../public/admin_images/applications-image-20.jpg';

function ShopCards06() {
  return (
    <React.Fragment>
      {/* Card 1 */}
      <div className="relative col-span-full sm:col-span-6 xl:col-span-3 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
        {/* Image */}
